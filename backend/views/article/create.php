                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <?= Html::activeTextInput($model, 'views',
                                        ['class' => 'form-control', 'data-v-rule' => 'digit', 'data-v-msg' => '必須為數字', 'value' => '0']) ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <?= Html::activeTextInput($model, 'share_location',
                                        ['class' => 'form-control', 'data-v-rule' => '', 'data-v-msg' => '']) ?>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <?php } ?>
                        ...
                        <div class="ibox-content">
                            ...
                            <div id="ad-item-info"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <p id="ad-item-detail" class="form-control-static">無</p>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                            </div>
